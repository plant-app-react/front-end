...
function About() {
    return (
        <section>
            <h3 className="text-center text-xl my-16 text-green-700">PlantiePie was designed and created by</h3>
            <div className="flex gap-24 justify-center">
                <div>
                    ...
                    <h4 className="text-3xl text-green-700">Lucía Marconi</h4>
                ...
                <div>
                    <h4 className="text-3xl text-green-700">Amparo Cabezuelo</h4>
                    <div className="flex gap-8 mt-8 justify-center text-4xl">
