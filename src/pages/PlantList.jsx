                ...
                {plants &&
                    plants.map(
                        (plant) => (
                            ...
                            <div className="max-w-sm overflow-hidden shadow-lg rounded-2xl transition duration-300 ease-in-out hover:scale-105" key={plant._id}>
                                <img className="w-full h-auto" src={plant.image} alt={plant.name} style={{ maxHeight: "450px" }} />
                                ...
                                <div className="px-6 pt-4 pb-2">
                                    ...
                                    <button onClick={() => deletePlant(plant._id)} className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2 hover:bg-red-600 hover:text-white">Delete</button>
